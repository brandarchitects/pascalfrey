...
export const metadata: Metadata = {
  ...
  description:
    "Pascal Frey ist via Email und LinkedIn erreichbar. Anfragen für Markenarbeit und Creative Direction in der Schweiz.",
};
        ...
        <Stack gap={32}>
          <Stack gap={16}>
            ...
            <p className="max-w-[50ch] text-[18px] leading-[1.5] text-gravel">
              Email funktioniert am besten. Antwortzeit normalerweise unter 48
              Stunden.
            </p>
          </Stack>
          ...
          <p className="max-w-[50ch] text-[14px] leading-[1.5] text-gravel">
            Aktuell offen für ausgewählte Projekte. Vollzeit ausgelastet bei
            Swisscom.
          </p>
        </Stack>
      </Container>
